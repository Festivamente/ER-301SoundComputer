...
function QuickSavePreset:apply(forceAll)
  local data = self.data
  if data == nil then
  ...
  if forceAll or Settings.get("quickSaveRestoresRecorder") == "yes" then
  ...
  if forceAll or Settings.get("quickSaveRestoresClipboard") == "yes" then
